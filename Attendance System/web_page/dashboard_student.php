...
<div class="wrapper">
  <div class="top_navbar">
    ...
    <div class="main_container" >
      ...
      <div class="class1">
          <a href="home_student.php"><div class="header"></div></a>
          <a href="home_student.php"><form class="CO">
            <strong style="color: #AF5D5D;">AST10201<br>Computer Organization</strong>
            <a href="home_student.php">2020AST10201</a>
          </form></a>
      </div>
      ...
      <div class="class2">
          ...
          <a href="home_student.php"><form class="CO">
            ...
            <a href="home_student.php">2020AST10303</a>
          </form></a>
      </div>
      ...
      <div class="class3">
          ...
          <a href="home_student.php"><form class="CO">
            ...
            <a href="home_student.php">2020AST10106</a>
          </form></a>
      </div>
